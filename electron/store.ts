...
export interface AppData {
  ...
  sponsors: { id: string; name: string; imagePath: string; tier: 'platinum' | 'gold' | 'silver' }[]
  sponsorStacks: {
    id: string
    name: string
    sponsorIds: string[]
  ...
  return {
    ...
    officials: officials
      ...
      .map((of) => ({
        ...
        role: (of.role === 'delegate' || of.role === 'referee' ? of.role : 'referee') as 'delegate' | 'referee',
      })),
    sponsors: sponsors
      .filter(
      ...
      .map((s) => ({
        ...
        tier: (s.tier === 'platinum' || s.tier === 'gold' || s.tier === 'silver' ? s.tier : 'gold') as 'platinum' | 'gold' | 'silver',
      })),
    sponsorStacks: sponsorStacks.filter((st): st is AppData['sponsorStacks'][number] => {
